<template>
  <div class="namespaces-show-page">
    <namespace-details-panel
      :namespace="namespace"
      :state="state"
      :teams-path="teamsPath"
      :webhooks-path="webhooksPath"
      :namespaces-path="namespacesPath">
    </namespace-details-panel>
...
import RepositoriesPanel from '@portus/modules/repositories/components/panel';
import WebhooksPanel from '@portus/modules/webhooks/components/panel';
