<template>
  <div>
    ...
    <table-pagination
      :total.sync="webhooks.length"
      :current-page="currentPage"
      :itens-per-page.sync="perPage"
...
<script>
import TableSortableMixin from '@portus/shared/mixins/table-sortable';
import TablePaginatedMixin from '@portus/shared/mixins/table-paginated';
